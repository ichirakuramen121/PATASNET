        ...
        <div className="p-6 sm:p-10 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
              ...
              <ul className="list-disc list-inside text-slate-600 space-y-1.5 pl-2 text-xs">
                <li><strong className="text-red-700 font-bold">Dilarang Keras Melakukan Reselling:</strong> Pelanggan dilarang keras menjual kembali, membagikan ulang (sharing bandwidth) ke lingkungan luar di luar bangunan terdaftar, memancarkan kembali (RT/RW Net), atau memungut biaya atas akses internet kami ke pihak ketiga tanpa izin kerja sama tertulis yang sah dari {currentCompany}. Pelanggaran atas klausul ini akan ditindak tegas berupa pemutusan kontrak sepihak dan denda administratif.</li>
